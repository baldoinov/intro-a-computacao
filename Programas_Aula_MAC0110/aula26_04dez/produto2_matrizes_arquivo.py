# -*- coding: utf-8 -*-
'''
   Arquivo: produto2_matrizes_arquivo.py
   -------------------------------------
...
def main():
    ...
    ###################################################################
    # Leitura dos dados da matriz A (nome da matriz, dimensao, e dados de cada linha)
    #### Fornecer o arquivo de entrada: dados2_produto.txt
   
    MatrizA = arqEntra.readline()  # Tem info no arquivo de entrada dizendo que comeca os dados da matriz A 
    # Não vamos imprimir essa info  (Veja o arquivo de entrada chamado dados2_produto.txt)
    ...
    # Leitura dos dados da matriz B (nome da matriz, dimensao, e dados de cada linha) 
    ##################################################################################
    MatrizB  = arqEntra.readline()   # Tem info no arquivo de entrada dizendo que comeca os dados da matriz B <====
    # Não vamos imprimir essa info  (Veja o arquivo de entrada chamado dados2_produto.txt)    
